...
| Raw anomaly recall | 93% | `[TBD]` | `[TBD]` |
| False positives per clean workbook | 23.00 | `[TBD]` | `[TBD]` |
| Localisation accuracy | 100% | `[TBD]` | `[TBD]` |
| Repair accuracy | n/a | `[TBD]` | `[TBD]` |
| Human time per workbook | not measured | `[TBD]` | `[TBD]` |
| Cost per workbook | none, no model involved | `[TBD]` | `[TBD]` |
