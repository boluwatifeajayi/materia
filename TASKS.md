...
| T20 | Solution scored run, no gate | DONE | **OpenAI. Full corpus, materiality gate disabled.** Record as changelog Iteration 2. This isolates hypothesis testing from materiality filtering. |
